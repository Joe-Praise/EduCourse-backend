...
type CertificateModel = Model<CertificateType, {}, CertificateMethods> &
  CertificateStatics;
...
certificateSchema.pre<Query<CertificateDoc[], CertificateDoc>>(
  /^find/,
  function (next) {
...
const Certificate = model<CertificateType, CertificateModel>(
  "Certificate",
  certificateSchema
);
