...
export declare const setCourseUserIds: (req: Request, res: Response, next: NextFunction) => void;
export declare const createReview: (req: Request, res: Response, next: NextFunction) => void;
export declare const getAllReview: (req: Request, res: Response, next: NextFunction) => void;
