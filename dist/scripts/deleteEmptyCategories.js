...
async function main() {
    ...
    console.log(`Scanned ${categories.length} course category(ies); ${used.size} in use; ` +
    ...
    for (const c of orphans) {
        console.log(`  • ${c.name ?? '(unnamed)'}  [${String(c._id)}]`);
    }
    if (!APPLY) {
...
//# sourceMappingURL=deleteEmptyCategories.js.map